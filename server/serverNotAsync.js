...
app.post("/users", (req, res) => {
    ...
    /* Explanation of below:
        ...
        5.) back in server.js, we now have user and token.  .then sends the token to res.header which sends the token back as an HTTP response header and then user is sent back as well.
    */
